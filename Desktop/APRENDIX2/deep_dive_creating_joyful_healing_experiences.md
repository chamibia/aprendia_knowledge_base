...
| Field | Input |
| ----- | ----- |
| ID & Title | READING_M5_CJHRE – Creating Joyful and Healing Reading Experiences |
...
* **Examples / Variations:**
  ...
  * Teacher invites students to act out gestures and small movements (e.g. "Our character is dancing again, lets all do a little dance in our seats." )
...
* **Examples / Variations:**
  * When students share long ideas, teacher uses rephrasing to help synthesize for the class (e.g. "Thank you for sharing! I heard you say….. and ……. How could we incorporate that into our story?")
  ...
  * Teacher writes ideas on the board and have students work in groups to turn them into sentences (either written or spoken, depending on students' levels)
...
* **Examples / Variations:**
  * After a story, teacher asks students to draw or write their favorite part.
...
* **Examples / Variations:**
  ...
  * Teacher uses the past weekly text studies as themes for the scripts
...
| ----- | ----- | ----- | ----- | ----- | ----- |
| Which emotion? | Short story/text | 1. Teacher expressively reads a short story 2. Write 3-4 feeling words on the board 3. Ask students to point to the feeling that matches a moment in the story 4. Invite students to show the feeling with their face or with an action 5. A few students explain their choice | Older: Explain in pairs before sharing with the class | Students engage in expressive reading. Students connect story events to real emotions. | 10 minutes |
