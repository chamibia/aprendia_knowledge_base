...
| Field | Input |
| ----- | ----- |
| ID & Title | READING_M4_MMVFC – Making Meaning with Vocabulary, Fluency, and Comprehension |
...
* **Examples / Variations:**
  * Teacher writes the text study on a poster and display it during the whole week
...
* **Expanded Explanation:** Questions help guide student thinking and facilitate classroom discussion. Teachers who ask a variety of questions (literal, inference, prediction, deep, connection) support student critical thinking skills.
  ...
  * Prediction questions allow students to make a logical guess about what may happen or may happen next in a story (e.g. "After looking at the pictures, what do you think will happen in the story?" "What do you think will happen next?" "Now that we finished reading the story, what do you think our characters might do next?").
  * Deep questions are typically open-ended and do not have one correct answer, yet they make students think critically about a text (e.g. "How would our story have changed, or not changed, if…..?" "Do you think the problem would have been resolved sooner if…?").
  * Connection questions allow students to apply the text to their own lives and experiences (e.g "How does this connect to you?" "How could you apply the lesson from the story to your own life?"). Students should never be pressured to share answers to connection questions.
...
* **Examples / Variations:**
  ...
  * Teacher allows students to share answers in small groups or in pair first, then some groups share with the whole class
...
| ----- | ----- | ----- | ----- | ----- | ----- |
| Clap and retell | Short story/text | 1. Teacher reads a short story aloud 2. Teacher reviews sequencing words with the class (e.g first, next, then, after, finally) 3. Students sit or stand in a circle 4. Teacher begins retelling the story, "First…", sharing one event 5. Teacher claps and calls a student's name 6. That student continues the retell with a sequencing word 7. Student claps and calls on another classmate 8. Continue until the story is retold | Younger: Allow students to look at pictures while retelling Older: Students include specific details | Students understand the order of events | 10 minutes |
